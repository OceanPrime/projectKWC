                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="name">Nama Costumer</label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="local-address">Size</label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="local-address">Model</label>
                                            <input type="text" id="local-address" class="form-control"
                                                placeholder="" name="local-address">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="local-address">Tanggal</label>
                                    ...
                                    <div class="col-12 d-flex justify-content-start">
                                        ...
                                        <a href="<?=base_url('/dev/costumer'); ?>" class="btn btn-danger me-1 mb-1">
                                            Cancel
                                        </a>
                                    </div>
                                </div>
